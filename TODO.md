...
- [x] Thunderbird Calendar is empty -> https://github.com/kewisch/gdata-provider/issues/140
...
- [x] Command&Conquerer Generals does not start anymore :\(

## Features

- [x] i3 Session restore
